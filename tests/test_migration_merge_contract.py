...
def test_ranked_and_trend_reliability_revisions_share_one_history() -> None:
    ...
    assert script.get_heads() == ["0024_trend_activation_performance"]

    performance = script.get_revision("0024_trend_activation_performance")
    assert performance.down_revision == "0023_autonomous_trend_activation"
